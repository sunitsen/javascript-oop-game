...
window.addEventListener('load', function () {
    ...
    class UI {
        ...
        draw(context) {
            ...
            context.fillText('Time ' + formateTime, 20, 100);
            ...
            if (this.game.gameOver) {
                ...
                context.fillText(message2, this.game.width * 0.5, this.game.height * 0.5 + 20); // Correct y-position for second message
            }
